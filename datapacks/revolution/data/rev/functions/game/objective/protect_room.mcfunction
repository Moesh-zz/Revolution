...
execute unless block 253 104 144 minecraft:lever run setblock 253 104 144 minecraft:lever[powered=false,facing=south]
...
execute unless blocks 254 103 144 253 103 144 255 146 201 all run fill 254 103 144 253 103 144 minecraft:air

execute unless blocks 251 103 145 256 106 148 255 146 201 all run fill 251 103 145 256 106 148 minecraft:air

# Red room
execute unless block 253 104 244 minecraft:lever run setblock 253 104 244 minecraft:lever[powered=false,facing=north]
